...
# Prepare Variables
Param (
    [parameter(Mandatory=$false,Position=0)][String]$ComputerName = "AD-01.ihle.de",
	[parameter(Mandatory=$false,Position=1)][Int]$Hours = 24,
	[parameter(Mandatory=$false,Position=2)][String]$FileName,
	[parameter(Mandatory=$false,Position=3)][bool]$ExportToFile = $false
)
